...
WebUI.callTestCase(findTestCase('Pages/User Add Product/Input Product Category'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/User Add Product/Input Product Description'), [('description') : 'Good Quality Product'], 
