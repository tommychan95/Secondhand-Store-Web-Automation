...
WebUI.setText(findTestObject('Page_Login/login_input_email'), 'binarqae1@gmail.com')

WebUI.setText(findTestObject('Page_Login/login_input_password'), 'students1234')

WebUI.click(findTestObject('Page_Login/login_btn'))

WebUI.verifyElementVisible(findTestObject('Page_Profile/icon_profile'))
